...
async def fork_repo_callback(client, query):
    await query.message.edit_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    styled_button("🚀 Fᴏʀᴋ Rᴇᴘᴏ", url="https://t.me/+IYgmL_vwW0cxNGI1", style=enums.ButtonStyle.PRIMARY),
                    styled_button("⚡ Hᴇʀᴏᴋᴜ Dᴇᴘʟᴏʏ", url="https://t.me/+IYgmL_vwW0cxNGI1", style=enums.ButtonStyle.PRIMARY)
                ],
                [
